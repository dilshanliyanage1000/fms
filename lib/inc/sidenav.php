        ...
        <div class="wrapper custom-collapse">
            ...
            <div class="sidebar">
                <div class="sidebar-menu" style="margin-left: 5px;">
                    ...
                    <li class="item" id="systemconfig">
                        <a href="#systemconfig" class="menu-btn" id="textzoom">
                            <i class="fas fa-tools"></i><span>Configurations<i class="fas fa-chevron-down drop-down"></i></span>
                        </a>
                        <div class="sub-menu">
                            <a href="../jobrole/jobrole.php"><i class="fas fa-user-tie"></i><span>Employee Jobrole</span></a>
                            <a href="../sys_users/system_users.php" id="sys_users"><i class="fas fa-address-card"></i><span>System Users</span></a>
                            <a href="../miscellaneous/rm_to_part.php"><i class="fas fa-sliders-h"></i><span>Manage RM-Part</span></a>
                            <a href="../miscellaneous/part_to_prod.php"><i class="fas fa-sliders-h"></i><span>Manage Part-Product</span></a>
                        </div>
                    </li>
                    <hr>
